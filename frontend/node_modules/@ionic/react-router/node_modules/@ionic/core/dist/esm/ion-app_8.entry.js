...
import { t as transition } from './index-ef6af852.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-a7345270.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          ...
          import('./input-shims-41dd9604.js').then((module) => module.startInputShims(config, platform));
        }
